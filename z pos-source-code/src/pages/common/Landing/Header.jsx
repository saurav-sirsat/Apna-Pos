          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-2 group cursor-pointer" onClick={() => navigate('/')}>
                <div className="w-12 h-12 bg-gradient-to-br from-primary via-primary/80 to-primary/60 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105 group-hover:rotate-3 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-t from-transparent to-white/20 rounded-2xl"></div>
                  <ShoppingCart className="w-7 h-7 text-primary-foreground relative z-10 drop-shadow-md" />
                  <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full shadow-lg animate-pulse"></div>
                </div>
                <span className="text-xl font-bold text-foreground group-hover:text-primary transition-colors">Apna POS</span>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Button onClick={() => navigate('/auth/signup')} className="font-medium shadow-md hover:shadow-lg transition-shadow">Sign Up</Button>
            </nav>
            ...
            <div className="md:hidden py-4 border-t border-border bg-background">
              <nav className="flex flex-col">
                ...
                <div className="flex flex-col space-y-3 p-4">
                  ...
                  <Button onClick={() => navigate('/auth/signup')} className="w-full">Sign Up</Button>
